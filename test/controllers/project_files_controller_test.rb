...
class ProjectFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_file" do
    assert_difference('ProjectFile.count') do
      post project_files_url, params: { project_file: { description: @project_file.description, name: @project_file.name, project_folder_id: @project_file.project_folder_id, user_id: @project_file.user_id } }
    end
  ...
  test "should update project_file" do
    patch project_file_url(@project_file), params: { project_file: { description: @project_file.description, name: @project_file.name, project_folder_id: @project_file.project_folder_id, user_id: @project_file.user_id } }
