...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { image: @institution.image, name: @institution.name, short_name: @institution.short_name } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { image: @institution.image, name: @institution.name, short_name: @institution.short_name } }
